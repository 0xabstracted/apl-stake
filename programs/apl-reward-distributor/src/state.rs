...
pub const STAKOR_REWARD_ENTRY_SEED: &str = "stakor-reward-entry";
pub const STAKOR_REWARD_ENTRY_SIZE: usize = 8 + std::mem::size_of::<StakorRewardEntry>() + 64;
#[account]
pub struct StakorRewardEntry {
    pub bump: u8,
    pub stake_pool: Pubkey,
    pub stakor_reward_distributor: Pubkey,
    pub stakor_reward_seconds_received: u128,
    pub multiplier: u64,
}

#[derive(Clone, Debug, PartialEq, Eq, AnchorSerialize, AnchorDeserialize)]
#[repr(u8)]
pub enum StakorRewardDistributorKind {
    /// Rewards are distributed by minting new tokens
    Mint = 1,
    /// Rewards are distributed from a treasury
    Treasury = 2,
...
pub const STAKOR_REWARD_DISTRIBUTOR_SEED: &str = "stakor-reward-distributor";
pub const STAKOR_REWARD_DISTRIBUTOR_SIZE: usize = 8 + std::mem::size_of::<StakorRewardDistributor>() + 64;
#[account]
pub struct StakorRewardDistributor {
    pub bump: u8,
    pub stake_pool: Pubkey,
    pub kind: u8,
    pub authority: Pubkey,
